...
CREATE TABLE `user` (
  ...
  `signature` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL default '' COMMENT '用户签名',
  `session_key` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `openid` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `unionid` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL default '',
